    ...
    <div class="container-botones-sisguiente-anterior">
        ...
        <script>
            ...
            function cargarElementos(page = 1) {
                    ...
                    fetch('/admin/taxonomias/get', { // Cambia esto por la URL real
                        method: 'POST',
                        headers: {
                            ...
                            contenedor.innerHTML += `<div>
                                                       <div>
                                                            ...
                                                            <div class="container-seccion-elemento">
                                                                <p>Nombre de la taxonomia</p>
                                                                <div><p>${elemento.name}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <a class="ver-elemento-individual" href="http://sistema3.test/admin/taxonomias/${elemento.id}">Ver taxonomia</a>
                                                            </div>
