...
<div class="form-update-div" id="form-update-elemento-div">
        ...
        <h3>Actualizar mi procedencia</h3>
        <form id="update-elemento" method="POST" data-update-elemento-id="">
            ...
            <div class="form-group">
                <button class="button" type="submit">Actualizar procedencia</button>
            </div>
        </form>
</div>
<script>
    ...
    function obtenerElementoPorId(id) {
       ...
       // Configurar la solicitud
        ...
        request.open('GET', '/admin/procedencias/get/' + id, true);
    ...
    document.getElementById('update-elemento').addEventListener('submit', function (event) {
        ...
        xhr.open('POST', '/admin/procedencias/update/' + misEmpresaId, true);
    ...
    function eliminarElemento(id) {
        let xhr = new XMLHttpRequest();
        xhr.open('DELETE', '/admin/procedencias/delete/' + id, true);
