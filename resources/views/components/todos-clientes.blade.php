<div class="container-elementos container-elementos-clientes">
    ...
    <div class="filtros-principales" id="filtros-principales">
        <div>
            ...
            <div class="seccion-filtro">
                 <h3>Email</h3>
                 <input type="text" id="email-filtro" placeholder="Email...">
            </div>
            <div class="seccion-filtro">
    ...
    <div class="container-botones-sisguiente-anterior">
        ...
        <script>
            ...
            function cargarElementos(page = 1) {
                    ...
                    const empresaId = document.getElementById('resultados-seleccionadosempresaFiltro').value;
                    const email = document.getElementById('email-filtro').value;
                    ...
                    fetch('/admin/clientes/get', { // Cambia esto por la URL real
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {        
                        ...
                        data.elementos.data.forEach(elemento => {
                            ...
                            const rutaImagenEmpresa = elemento.empresa && elemento.empresa.imagen_destacada ? '<img src="http://sistema3.test/storage/' + elemento.empresa.imagen_destacada.ruta + '" alt="">' : '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M480 48c0-26.5-21.5-48-48-48H336c-26.5 0-48 21.5-48 48V96H224V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V96H112V24c0-13.3-10.7-24-24-24S64 10.7 64 24V96H48C21.5 96 0 117.5 0 144v96V464c0 26.5 21.5 48 48 48H304h32 96H592c26.5 0 48-21.5 48-48V240c0-26.5-21.5-48-48-48H480V48zm96 320v32c0 8.8-7.2 16-16 16H528c-8.8 0-16-7.2-16-16V368c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16zM240 416H208c-8.8 0-16-7.2-16-16V368c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16zM128 400c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V368c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32zM560 256c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H528c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32zM256 176v32c0 8.8-7.2 16-16 16H208c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16zM112 160c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h32zM256 304c0 8.8-7.2 16-16 16H208c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32zM112 320H80c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16zm304-48v32c0 8.8-7.2 16-16 16H368c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16zM400 64c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H368c-8.8 0-16-7.2-16-16V80c0-8.8 7.2-16 16-16h32zm16 112v32c0 8.8-7.2 16-16 16H368c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16z"/></svg>';
                            const rutaEmpresa = elemento.empresa ? '<div class="container-seccion-usuario"><div class="elemento-user-image">' + rutaImagenEmpresa + '</div><div class="elemento-user-name"><span>Empresa</span><p>' + elemento.empresa.name + '</p></div></div>' : '';
 
                            const sucursalName = elemento.sucursal_id ? '<div class="container-seccion-elemento"><p>Sucursal</p><div><p>' + elemento.sucursal.name + '<p></div></div>' : '';
                            const cargo = elemento.cargo ? '<div class="container-seccion-elemento"><p>Cargo</p><div><p>' + elemento.cargo + '<p></div></div>' : '';
                            const area = elemento.area_id ? '<div class="container-seccion-elemento"><p>Area</p><div><p>' + elemento.area.name + '<p></div></div>' : '';
                            ...
                            contenedor.innerHTML += `<div>
                                                       <div>
                                                            ...
                                                            <div class="container-seccion-elemento">
                                                                <p>Email</p>
                                                                <div><p>${elemento.email}</p></div>
                                                            </div>
                                                            ${area}
                                                            ${cargo}
                                                            <div class="container-seccion-elemento">
                                                                <p>Ruc</p>
                                                                <div><p>${elemento.ruc}</p></div>
                                                            </div>
                                                            <div class="container-seccion-elemento">
                                                                <p>Telefono</p>
                                                                <div><p>${elemento.telefono}</p></div>
                                                            </div>
                                                            <div class="container-seccion-elemento">
                                                                <p>Dirección</p>
                                                            ...
                                                            <div class="container-seccion-elemento">
                                                                <p>Tipo</p>
                                                                <div><p>${elemento.tipo}</p></div>
                                                            </div>
                                                            <div class="container-seccion-elemento">
                                                                <a class="ver-elemento-individual" href="http://sistema3.test/admin/clientes/${elemento.id}">VER CLIENTE</a>
                                                            </div>
                                                        </div>
