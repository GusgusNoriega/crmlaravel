   ...
   <div class="container-botones-sisguiente-anterior">
       ...
       <script>
           ...
           function cargarEmpresas(page = 1) {
                   ...
                   fetch('/admin/empresas/get', { // Cambia esto por la URL real
                       method: 'POST',
                       headers: {
                   ...
                   .then(data => {        
                       ...
                       data.elementos.data.forEach(elemento => {
                           ...
                           contenedor.innerHTML += `<div>
                                                      <div>
                                                           ...
                                                           <div class="container-seccion-elemento">
                                                            <a class="ver-elemento-individual" href="http://sistema3.test/admin/empresas/${elemento.id}">VER EMPRESA</a>
                                                           </div>  
                                                       </div>
                       ...
                       if (data.elementos.current_page < data.elementos.last_page) {
                           ...
                           botonCargar.onclick = () => {
                               cargarEmpresas(data.elementos.current_page + 1);
                           };
                       } else {
