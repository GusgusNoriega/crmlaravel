    ...
    <div class="container-div-agregar-elementos" id="container-div-agregar-elementos">
        ...
        <form action="" method="POST" id="register-elementos">
            ...
            <div class="form-group">
                <label for="name">Nombre del Moneda</label>
                <input type="text" name="name" id="name" required>
            </div>

            <div class="form-group">
                <label for="code">Codigo de moneda (mayusculas)</label>
                <input type="text" name="code" id="code" oninput="this.value = this.value.toUpperCase()" required>
            </div>

            <div class="form-group">
                <label for="tipo_cambio">Tipo de cambio</label>
                <input type="number" step="0.01" name="tipo_cambio" id="tipo_cambio" required>
            </div>

            <div class="form-group">
                <label for="symbol">Simbolo</label>
                <input type="text" step="0.01" name="symbol" id="symbol" required>
            </div>

            <div class="form-group">
                <button type="submit" class="button">Crear Moneda</button>
            </div> 
        </form>
    </div>
<script> 
        ...
        document.getElementById('register-elementos').addEventListener('submit', function (event) {
            ...
            xhr.open('POST', '/admin/monedas/create', true);
