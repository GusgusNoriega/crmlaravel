    ...
    <div class="container-botones-sisguiente-anterior">
        ...
        <script>
            ...
            function cargarElementos(page = 1) {
                    ...
                    fetch('/admin/monedas/get', { // Cambia esto por la URL real
                        method: 'POST',
                        headers: {
                            ...
                            contenedor.innerHTML += `<div>
                                                       <div>
                                                            ...
                                                            <div class="container-seccion-elemento">
                                                                <p>Nombre de la moneda</p>
                                                                <div><p>${elemento.name}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <p>Codigo</p>
                                                                <div><p>${elemento.code}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <p>Simbolo</p>
                                                                <div><p>${elemento.symbol}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <p>tipo de cambio</p>
                                                                <div><p>${elemento.tipo_cambio}<p></div>
                                                            </div>
