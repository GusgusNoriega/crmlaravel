    ...
    <div class="container-div-agregar-elementos" id="container-div-agregar-elementos">
        ...
        <form action="" method="POST" id="register-elementos">
            ...
            <div class="form-group">
              ...
              <input type="datetime-local" name="fecha_asignada" id="fecha_asignada">
            </div>

            <div class="form-group">
                <textarea name="contenido" id="contenido-comentario" cols="30" rows="10"></textarea>
            </div>

           
            @if ($elementoId)
                <input type="hidden" name="comentable_id" value="{{ $elementoId }}">
            @endif 
            @if ($modeloType)
                 <input type="hidden" name="comentable_type" value="{{ $modeloType }}"> 
            @endif
