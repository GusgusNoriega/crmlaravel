    ...
    <div class="container-div-agregar-elementos" id="container-div-agregar-elementos">
        ...
        <form action="" method="POST" id="register-elementos">
            ...
            <div class="form-group">
                ...
                <input type="text" name="clave_key" id="clave_key" required>
            </div>
            <div class="form-group">
                <label for="clave_secret">Clave secret</label>
                <input type="text" name="clave_secret" id="clave_secret" required>
            </div>
            <div class="form-group">
            ...
            <input type="hidden" name="tipo" value="woocommerce">
            
            <div class="form-group">
                <button type="submit" class="button">Crear nueva coneccion api</button>
            </div> 
        </form>
    </div>
<script>
        ...
        document.getElementById('register-elementos').addEventListener('submit', function (event) {
            ...
            xhr.open('POST', '/admin/apis/create', true);
