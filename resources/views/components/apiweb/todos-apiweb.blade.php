    ...
    <div class="container-botones-sisguiente-anterior">
        ...
        <script>
            ...
            function cargarElementos(page = 1) {
                    ...
                    fetch('/admin/apis/get', { // Cambia esto por la URL real
                        method: 'POST',
                        headers: {
                            ...
                            contenedor.innerHTML += `<div>
                                                       <div>
                                                            ...
                                                            <div class="container-seccion-elemento">
                                                                <p>Nombre de la api</p>
                                                                <div><p>${elemento.name}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <p>Alias la api</p>
                                                                <div><p>${elemento.alias}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <p>Web la api</p>
                                                                <div><p>${elemento.web}<p></div>
                                                            </div>

                                                            <div class="container-seccion-elemento">
                                                                <a href="http://sistema3.test/admin/apis/${elemento.id}" class="ver-elemento-individual">Sincronizar Productos</a>
                                                            </div>
