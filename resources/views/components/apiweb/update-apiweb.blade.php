...
<div class="form-update-div" id="form-update-elemento-div">
        ...
        <form id="update-elemento" method="POST" data-update-elemento-id="">
            ...
            <div class="form-group">
                ...
                <input type="url" id="web-update" name="web" required>
            </div>

            <div class="form-group">
                <label for="clave_key">Clave key</label>
                <input type="text" name="clave_key" id="clave-key-update" required>
            </div>

            <div class="form-group">
                <label for="clave_secret">Clave secret</label>
                <input type="text" name="clave_secret" id="clave-secret-update" required>
            </div>

            <div class="form-group">
                <label for="alias">Alias (se mostrara en los productos descargados)</label>
                <input type="text" name="alias" id="alias-update" required>
            </div>

            <div class="form-group">
                <button class="button" type="submit">Actualizar Area</button>
            </div>
        </form>
</div>
<script>
    ...
    function llenarFormularioConDatos(datos) {
        ...
        document.querySelector('#web-update').value = datos.web || '';
        document.querySelector('#clave-key-update').value = datos.clave_key || '';
        document.querySelector('#clave-secret-update').value = datos.clave_secret || '';
        document.querySelector('#alias-update').value = datos.alias || '';
    ...
    function obtenerElementoPorId(id) {
       ...
       // Configurar la solicitud
        ...
        request.open('GET', '/admin/apis/get/' + id, true);
    ...
    document.getElementById('update-elemento').addEventListener('submit', function (event) {
        ...
        xhr.open('POST', '/admin/apis/update/' + misEmpresaId, true);
    ...
    function eliminarElemento(id) {
        let xhr = new XMLHttpRequest();
        xhr.open('DELETE', '/admin/apis/delete/' + id, true);
