    ...
    <div class="container-div-agregar-elementos" id="container-div-agregar-elementos">
        ...
        <form action="" method="POST" id="register-elementos">
            ...
            <div class="form-group form-group-25">
                ...
                <input type="text" name="garantia" id="garntia" required>
            </div>
           ...
           <input type="hidden" name="total_productos" id="total-productos" required>
            ...
            <div class="form-group">
                <button id="submitBtnCrear" type="submit" class="button">Crear cotización</button>
            </div> 
        </form>
    </div>
<script>
        ...
        document.getElementById('register-elementos').addEventListener('submit', function (event) {
            ...
            document.getElementById('submitBtnCrear').disabled = true;

            let form = this;
            let formData = new FormData(form);
    
            let xhr = new XMLHttpRequest();
            xhr.open('POST', '/admin/cotizaciones/create', true);
            xhr.setRequestHeader('X-CSRF-TOKEN', document.querySelector('meta[name="csrf-token"]').content);

            xhr.onreadystatechange = function () {
                if (xhr.readyState === XMLHttpRequest.DONE) {

                    document.getElementById('submitBtnCrear').disabled = false;
