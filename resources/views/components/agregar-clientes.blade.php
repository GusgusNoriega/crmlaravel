<div class="container-agregar-usuario container-agregar-elemento">
    ...
    <div class="container-div-agregar-elementos" id="container-div-agregar-elementos">
        ...
        <h3>Agregar mi Clientes</h3>
        <form action="" method="POST" id="register-elementos">
            @csrf
            <div class="form-group contain-image-agre">
                <input type="hidden" name="image_id" value="">
                <button id="imagen-cambiar-3" type="button" class="seleccion-produc-individual seleccionar-archivos button" data-product-id="" data-limit="1">Selecionar imagen destacada</button>
            ...
            <x-buscador-empresa id-principal="empresa3" nombre="empresas" cantidad="1"/>
            
            <x-sucursales.sucursal-por-empresa elemento-id="empresa3"/> 
                  
            <div class="form-group">
                <x-areas.select-areas selectId="area2" />
            </div>

            <div class="form-group">
                <label for="agregar-cargo">Cargo</label>
                <input type="text" name="agregar-cargo">
            </div>
 ...
 <script>
        ...
        document.getElementById('register-elementos').addEventListener('submit', function (event) {
            ...
            xhr.open('POST', '/admin/clientes/create', true);
